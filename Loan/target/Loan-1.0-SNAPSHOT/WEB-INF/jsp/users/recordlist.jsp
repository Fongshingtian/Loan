					...
					<tbody class="news_content">
						...
						<tr>
							<td colspan="7">
								...
								<a href="/myusers/recordlsit?currPage=1">首页</a>
								<a href="/myusers/recordlsit?currPage=${currpage-1}">上一页</a>
								<a href="/myusers/recordlsit?currPage=${currpage+1}">下一页</a>
								<a href="/myusers/recordlsit?currPage=${totalpage}">尾页</a>
