...
<head>
    ...
    <script charset="utf-8" src="/jsp/VIPCenter/files/v.js"></script>
    <script src="/jsp/VIPCenter/files/hm.js"></script>
    ...
    <link rel="stylesheet" href="/jsp/VIPCenter/files/style-048337cfe8.css">
...
<%--<div class="menu-list head-menu">--%>
    <%--&lt;%&ndash;<div class="g-o" style="width:1170px;">&ndash;%&gt;--%>
        ...
        <%--&lt;%&ndash;</a>&ndash;%&gt;--%>
        <%--&lt;%&ndash;<input id="_point_current_menu" type="hidden" value="mall">&ndash;%&gt;--%>
        <%--&lt;%&ndash;<ul class="nav">&ndash;%&gt;--%>
            <%--&lt;%&ndash;<li>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<a href="https://www.xiaoniu88.com/activity/pointmall/usual/index" id="_menu_mall" class="cur">积分兑换</a>&ndash;%&gt;--%>
            <%--&lt;%&ndash;</li>&ndash;%&gt;--%>
            <%--&lt;%&ndash;<!--  -->&ndash;%&gt;--%>
            <%--&lt;%&ndash;<li>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<a href="https://www.xiaoniu88.com/activity/pointmall/usual/pointrule" id="_menu_rule">积分规则</a>&ndash;%&gt;--%>
            <%--&lt;%&ndash;</li>&ndash;%&gt;--%>
            <%--&lt;%&ndash;<li>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<a href="https://www.xiaoniu88.com/activity/pointmall/usual/pointfaq" id="_menu_faq">积分问答</a>&ndash;%&gt;--%>
            <%--&lt;%&ndash;</li>&ndash;%&gt;--%>
        <%--&lt;%&ndash;</ul>&ndash;%&gt;--%>
    <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
<%--</div>--%>
...
<div class="breadcrumb">
    <div class="section">
        ...
        <a href="https://www.xiaoniu88.com/activity/pointmall/usual/index">积分商城</a> &gt; 商城列表
    </div>
</div>
<div class="section">
    <div id="mall_list_filter">
        <dl class="mall-list-tab">
            ...
            <dd id="productAreaList">
                <span data-productareaid="all" class="filter active">全部</span>
        </dl>
        <div class="mall-list-sort" id="sortList">
            <span class="filter active js_sort_default" data-sort="default" data-sortby="0">默认排序 <i>↓</i></span>
            <span class="filter js_sort_points" data-sort="points" data-sortby="0">兑换积分 <i>↓</i></span>
        </div>
    </div>
    <div class="pointmall-container" id="container">
        <ul class="floor-list lg-list g-cf" id="productList" style="display: block;">
            <c:forEach items="${list}" var="l">
                <li>
                    <a href="/vip/point/mall/detail/${l.id}">
                        <img src="${pageContext.request.contextPath}/upload/${l.image}">
                    </a>
                    <div>
                        <p class="name" title="Apple Watch Sport Series 3  银色">${l.name}</p>
                        <p class="orange">积分：${l.point}</p>
                    </div>
        ...
        <div class="pages">
            <div class="page">第<i class="pg" id="currpage">${currpage}</i>页/共<i id="totalpage" class="cal">${totalpage}</i>页
                <a data-page="fast" href="javascript:void(0);" id="first" onclick="choosePage(1)">首页</a>
                <a data-page="up" id="last" href="javascript:void(0);" onclick="choosePage(${currpage-1})">上一页</a>
                <select onchange="choosePage(this.value)"  id="selpage">
                    <c:forEach begin="1" var="t" end="${totalpage}">
                        <c:choose>
                            <c:when test="${t!=currpage}">
                ...
                <a data-page="down" id="next" href="javascript:void(0)" onclick=" choosePage(${currpage+1})">下一页</a>
                <a data-page="last" id="end" href="javascript:void(0)" onclick="choosePage(${totalpage})">末页</a></div>
            <input type="hidden" id="pageCal" value="16">
        </div>
    </div>
</div>
<script src="/jsp/VIPCenter/files/list-5953a99df7.js"></script>
<script>
    // $(function(){
    //     seajs.use('page/activity/pointmall/list/js/list');
    // });
</script>
<div class="footer">
...
<script>
    function choosePage(page){
        if(page!=0&&page!="${currpage}"&&page!="${totalpage+1}"){
            window.location.href="/vip/point/mall/"+page;
        }
    }
</script>
