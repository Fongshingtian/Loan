...
<div class="product-menu-contanier" id="productMenu">
    <ul class="product-menu clearfix">
        ...
        <li>
            <a href="/product/list?type=common" id="menu_common">散标 (<em id="commonCount">售罄</em>)</a>
        </li>
        <li>
    ...
    <div class="list-box">
        ...
        <div class="list-row">
            <c:forEach items="${zbgjList}" var="zbgj">
                <a class="row-item g-cf " href="/invest/selinvestbyid/${zbgj.sid}">
    ...
    <div class="list-box">
        ...
        <div class="list-col g-cf col5">
            <c:forEach items="${yunlist}" var="yun">
                <a class="col-item g-cf disabled" href="/product/bid/detail/65106653?specialArea=1&amp;productType=11">
