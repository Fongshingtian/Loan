...
<html lang="en"><head>
    ...
    <title>关于近期不法分子冒用小牛普惠名义进行诈骗的公告-小牛普惠</title>
...
<div class="box-gry box-paddingb">
    <div class="crumbs">
        <%--<a href="#">首页&nbsp;</a>&gt;
        <a href="#">关于我们</a>&gt;
        <a href="/wlk/toNewsList">新闻公告</a>--%>
    </div>
    <div class="body-wrap">

        <div class="wlk" style="width:85%;margin: auto;margin-left:50px;">
            <div class="wrap-right-title"><%--类型--%>
                <font style="font-size:large">${oneNew.ntype}</font>
            </div>

            <%--主体--%>
            <div class="newsDetail-right clearfix">
                <h3 class="txt-m-grey text-center">${oneNew.ntitle}</h3>
                <h6 class="news-detail-time text-center news-grey-m">
                    <%--2018${oneNew.rdate}-08-24&nbsp;&nbsp;&nbsp;&nbsp;
                    17:27:49--%>
                        ${oneNew.rdate}
                </h6>
                <div class="news2-con-text"><div style="text-align:center;">
                    <%--<img src="https://website-img.xnph66.com/static/pics/news/1535101463149876.gif" alt=""><br>
                --%>
                     ${oneNew.ncontent}
                </div></div>
