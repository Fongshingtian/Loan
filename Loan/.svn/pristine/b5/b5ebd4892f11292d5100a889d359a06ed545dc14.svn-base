					...
					<tbody class="news_content">
						...
						<tr>
							<td colspan="10">
								...
								<a href="/myusers/yhklist?currpage=1">首页</a>
								<a href="/myusers/yhklist?currpage=${currpage-1}">上一页</a>
								<a href="/myusers/yhklist?currpage=${currpage+1}">下一页</a>
								<a href="/myusers/yhklist?currpage=${totalpage}">尾页</a>
