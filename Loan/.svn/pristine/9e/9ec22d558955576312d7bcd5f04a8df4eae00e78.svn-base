        ...
        <div class="center user-box">
            ...
            <div class="account-list">
                ...
                <ul class="g-cf left-menu">
                    ...
                    <li data-type="news">
                        <a href="/MyAccount/message">我的消息<span id="msg-count">(2)</span></a>
                    </li>
                                            ...
                                            <div class="jymm_xg">
                                                <table class="form_type">
                                                    <tbody><tr>
                                                        ...
                                                        <td class="width220"><input name="jymm_xg_old_trapwd" id="jymm_xg_old_trapwd" oncut="return false" oncopy="return false" oncontextmenu="return false" onpaste="return false" type="password"></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input name="jymm_xg_trapwd_qr" id="jymm_xg_trapwd_qr" type="password" oncut="return false" oncopy="return false" oncontextmenu="return false" onpaste="return false"></td>
                                                        <td class="width250"><div id="jymm_xg_trapwd_qrTip" class="tips_content"></div></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="tips"></td>
                                                        <td class="tips"></td>
                                                    ...
                                                    <tr>
                                                        <td class="align_right">绑定手机：</td>
                                                        <td><span class="display_form">182****2525</span></td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="tips"></td>
                                                    ...
                                                    <tr>
                                                        <td class="align_right">验证码：</td>
                                                        <td><input id="jymm_xg_code" class="code_form" type="text"><a id="jymm_xg_getcode" class="get_code inline_block"><span class="get_code_text">获取验证码</span></a></td>
                                                        <td class="width250"><div id="jymm_xg_er" class="tips_content"></div></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="tips"></td>
                                                        <td class="tips" colspan="2"><div id="jymm_xg_potcode" class="msg_tips_con"></div></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="tips"></td>
                                                        <td class="tips"></td>
                                                    ...
                                                    <tr>
                                                        <td></td>
                                                        <td class=""><a id="jymm_xg_sub_btn" class="sbm_btn inline_block">确&nbsp;&nbsp;定</a></td>
                                                    </tr>
                                                    </tbody></table>
                                            </div>
                                        </div>
                        ...
                        <c:if test="${user.realname=='true'}">
                            ...
                            <c:if test="${real.bankcard!=null||real.bankcard!=''}">
                                <div class="column">
                                    ...
                                    <div class="column_msg">
                                        <span class="setting"><a href="/payment/bankcard/index">查看</a></span>
                                        <span class="column_info">提现时资金转入的银行卡账户</span>
                                ...
                                <div class="dlmm_xg">
                                    <table class="form_type">
                                        ...
                                        <tr>
                                            ...
                                            <td><input id="dlmm_xg_old_pwd" type="password" oncut="return false"
                                        ...
                                        <tr>
                                            ...
                                            <td><input id="dlmm_xg_new_pwd" type="password" oncut="return false"
                                                       oncopy="return false" oncontextmenu="return false"
                                                       onpaste="return false"></td>
                                            <td class="width250">
                                        ...
                                        <tr>
                                            <td class="align_right">确认新密码：</td>
                                            <td><input id="dlmm_xg_new_pwd_qr" type="password" oncut="return false"
                                                       oncopy="return false" oncontextmenu="return false"
                                                       onpaste="return false"></td>
                                            <td class="width250">
                                        ...
                                        <tr>
                                            <td class="align_right">绑定手机：</td>
                                            <td><span class="display_form">151****6464</span></td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td class="tips"></td>
                                        ...
                                        <tr>
                                            <td class="align_right">验证码：</td>
                                            <td><input id="dl_xg_cdtx" class="code_form" type="text"><a id="dl_xg_code"
                                                                                                        class="get_code inline_block"><span
                                                    class="get_code_text">获取验证码</span></a></td>
                                            <td class="width250">
                                                <div id="dl_xg_er" class="tips_content"></div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="tips"></td>
                                            <td class="tips" colspan="2">
                                                <div id="dl_xg_codepot" class="msg_tips_con"></div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="tips"></td>
                                        ...
                                        <tr>
                                            <td></td>
                                            <td class=""><a id="dlmm_xg_submit" class="sbm_btn inline_block">确&nbsp;&nbsp;定</a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div myid="mobile" class="column">
                            ...
                            <div class="column_msg">
                                ...
                                <span class="phone_info">
										...
										<span class="info_con">151****6464</span>
									</span>
                                <!-- 判断是否是修改鉴权手机号 -->
                            </div>
                                    ...
                                    <div class="modify_mode1">
                                        <table class="form_type">
                                            ...
                                            <tr>
                                                <td class="align_right">当前号码：</td>
                                                <td>
                                                    <span class="display_form">151****6464</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="align_right">验证码：</td>
                                                <td><input id="sjyz_xg_step1_type1_pcode" class="code_form" type="text"><a
                                                        id="sjyz_xg_step1_type1_getpcode" class="get_code inline_block"><span
                                                        class="get_code_text">获取验证码</span></a></td>
                                            </tr>
                                            <tr>
                                                <td class="tips"></td>
                                            ...
                                            <tr>
                                                <td></td>
                                                <td class=""><a id="sjyz_xg_step1_type1_submit"
                                ...
                                <div class="yxrz_rz">
                                    <table class="form_type">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input id="yxrz_rz_email" type="text">
                                            </td>
                                            <td class="width250">
                                        ...
                                        <tr>
                                            <td class="align_right">验证码：</td>
                                            <td><input id="yxrz_rz_ecode" class="code_form" type="text"><a
                                                    id="yxrz_rz_getecode" class="get_code inline_block"><span
                                                    class="get_code_text">获取验证码</span></a></td>
                                        </tr>
                                        <tr>
                                            <td class="tips"></td>
                                            <td class="tips">
                                                <div id="yxrz_rz_ecodeTip" class="msg_tips_con"></div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td class=""><a id="yxrz_rz_submit" class="sbm_btn inline_block">确认</a></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="jjlxr_rz">
                                    <table class="form_type">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="selectArea">
                                                    <div id="jjlxr_rz_type" class="selected" val="">请选择</div>
                                        ...
                                        <tr>
                                            ...
                                            <td><input id="jjlxr_rz_name" type="text"></td>
                                            <td class="width250">
                                        ...
                                        <tr>
                                            ...
                                            <td><input id="jjlxr_rz_mobile" maxlength="11" type="text"></td>
                                            <td class="width250">
                                        ...
                                        <tr>
                                            <td></td>
                                            <td class=""><a id="jjlxr_rz_submit" class="sbm_btn inline_block">确认</a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
