...
<div id="box">
    ...
    <div class="zscf_banner px1000" align="center">
        <div class="zscf_box">
            <p>累计成交：<strong>${info.turnover}元</strong></p>
            <p>运营时间：<strong>${sdate}天</strong></p>
            <p>注册人数：<strong>${info.enrollment}</strong></p>
...
<div class="div14">
    ...
    <div class="div15">
        <div style="float:left;">
            ...
            <div class="btndiv"><a href="${pageContext.request.contextPath}/scatter/index"><button class="btn2s" style="border: 1px solid #45c722;color: #45c722;">查看详情</button></a></div>
        </div>
        <div class="conter"  style="    border-top: 2px solid #d3f2b4;">
            <div class="itemes">
                <c:forEach items="${scattere}" var="t">
                <div class="sbbox">
                    <div class="divpanel">
                        <div class="divfont1">${t.rate}<span class="divfon1">%</span></div>
                        ...
                        <div class="about">
                            ...
                            <div class="name">消费贷${t.uid}</div>
                            <div class="info"><div class="yield">期限：${t.term}个月</div></div>
                            <div class="extend">
                                <a class="btn" href="/scatter/xq?id=${t.id}">立即出借</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="conter"  style="    border-top: 2px solid #7cd3e9;">
            <div class="itemes">
                <c:forEach items="${yunlist}" var="r">
                    <a href="${pageContext.request.contextPath}/invest/selinvestbyidy/${r.sid}/${r.period}">
                    <div class="sbbox">
        ...
        <div class="conter"  style="    border-top: 2px solid #7cd3e9;">
            <div class="itemes">
                <c:forEach items="${scnlist}" var="r">
                    <a href="${pageContext.request.contextPath}/invest/selinvestbyid/${r.sid}/${r.period}">
                        <div class="sbbox">
                            <div class="divpanel">
