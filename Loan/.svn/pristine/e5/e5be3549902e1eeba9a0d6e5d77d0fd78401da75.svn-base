                ...
                <table class="layui-table">
                    ...
                    <c:forEach items="${list}" var="l">
                        <tr>
                            ...
                            <td>
                                <c:choose>
                                    <c:when test="${l.authentication==1}">
                                        已完成
                                    </c:when>
                                    <c:otherwise>
                                        未完成
                            ...
                            <td>
                                <c:choose>
                                    <c:when test="${l.bind_bank_card==1}">
                                        已完成
                                    </c:when>
                                    <c:otherwise>
                                        未完成
                            ...
                            <td>
                                <c:choose>
                                    <c:when test="${l.first_recharge_1h==1}">
                                        已完成
                                    </c:when>
                                    <c:otherwise>
                                        未完成
                            ...
                            <td>
                                <c:choose>
                                    <c:when test="${l.first_month_bid_5t==1}">
                                        已完成
                                    </c:when>
                                    <c:otherwise>
                                        未完成
                            ...
                            <td>
                                <c:choose>
                                    <c:when test="${l.first_month_bid_10t==1}">
                                        已完成
                                    </c:when>
                                    <c:otherwise>
                                        未完成
                            ...
                            <td>
                                <c:choose>
                                    <c:when test="${l.first_month_bid_30t==1}">
                                        已完成
                                    </c:when>
                                    <c:otherwise>
                                        未完成
                            ...
                            <td>
                                <c:choose>
                                    <c:when test="${l.first_month_bid_50t==1}">
                                        已完成
                                    </c:when>
                                    <c:otherwise>
                                        未完成
...
<script type="text/javascript">
    ...
    function choosePage(currpage){
        var phref="/vip/BackStage/task/"+currpage;
