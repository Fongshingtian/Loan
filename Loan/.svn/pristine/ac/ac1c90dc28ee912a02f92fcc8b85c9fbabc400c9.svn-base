...
<script>
    ...
    function ajx(mintime,maxtime,minmoney,maxmoney,hkfs,minsy,maxsy,px,page){
        ...
        $.post("fastJSONs3", {mintime:mintime,maxtime:maxtime,minmoney:minmoney,maxmoney:maxmoney,hkfs:hkfs,minsy:minsy,maxsy:maxsy,px:spx,i:page}, function (data) {
            // listModel
            $.each(data.uer,function(index,s){
                var a1=$("<a>",{
                    href:'/scatter/xq?id='+s.id
                });
                var div1=$("<div>",{
                    class:'item sell-out'
                });
                ...
                $(div2dl1).append(div2dl1dt);$(div2dl1).append(div2dl1dd);
                $(div2).append(div2dl1);
                var div2dl2=$("<dl>",{
                    class:'earnings'
                });
                ...
                var i=$("<i>",{
                    ...
                    title:'小牛在线P2P互联网金融平台所有项目参考利率是在参考同类型工具历史数据得出，并不代表实际收益，市场有风险，出借需谨慎。'
                });
                $(div2dl2dd).append(i);
                $(div2dl2).append(div2dl2dt);
                $(div2dl2).append(div2dl2dd);
                $(div2).append(div2dl2);
                var div2dl3=$("<dl>",{
                    class:'limit'
                });
                ...
                $(div2dl3dt).append(dti);
                var div2dl3dd=$("<dd>",{
                    text:'期限'
                });
                $(div2dl3).append(div2dl3dt);
                $(div2dl3).append(div2dl3dd);
                $(div2).append(div2dl3);
                var div2dl4=$("<dl>",{
                    class:'starting-amount'
                });
                var div2dl4dt=$("<dt>",{
                    text:''+s.amount-s.money
                });
                var div2dl4dd=$("<dd>",{
                    text:'剩余金额'
                });
                $(div2dl4).append(div2dl4dt);
                $(div2dl4).append(div2dl4dd);
                $(div2).append(div2dl4);
                var div2dl5=$("<dl>",{
                    class:'build-date'
                });
                ...
                $(div2dl5).append(div2dl5dt);
                $(div2dl5).append(div2dl5dd);
                $(div2).append(div2dl5);
                var svar='未结束';
                if(s.end!=0){
                    svar=s.time;
                ...
                $(div2dl6).append(div2dl6dd1);
                $(div2dl6).append(div2dl6dd2);
                $(div2).append(div2dl6);
                $(div1).append(div2);
                $(a1).append(div1);
                $("#listModel").append(a1);
