...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/zdzcss/account/bank_index-e3672a0ac0.css">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            if(bank=='true'){
                ...
                t3val+="************";
                for (var i = t3.length-4; i <t3.length ; i++) {
                    t3val+=t3[i];
                }
                $("#bankd").text(t3val);
            }
...
<div class="container">
    <div class="g-account-main">
        ...
        <div class="center user-box">
            ...
            <input type="hidden" value="${bank}" id="bankval">
            <!-- 左侧当前选中菜单 -->
            <c:if test="${bank=='true'}">
                <div class="account-cont">
                    <div class="at-til"><span class="name">我的银行卡</span></div>
                    <!--内容区 start-->
                    <!--已成功绑卡，且一张-->
                    <div class="order01">
                        <div class="formContent">
                            <div class="formContentTop">
                                <p style="color:#1e994c" class="hasbangding">
                                    已开通认证支付
                                    已绑定
                                </p>
                                <div class="formContentTip successBank">
                                    <span class="bank-ccb bank_icon"></span>
                                    <span class="bankOfType">储蓄卡</span>
                                    <input type="hidden" value="${real.bankcard}" id="bank">
                                    <span class="bankCode" id="bankd"></span>
                                </div>
                            </div>
                            <div class="formContentFloor">
                                <p>温馨提示：</p>
                                <p>1.若操作提现，提现资金将汇入此银行卡。</p>
                                <p>2.若需要解绑银行卡，请<a href="#">提交解绑申请</a>。</p>
                                <p>3.如果鉴权手机号已更新或快捷协议已失效，请重新进行<a href="#">银行卡认证</a>。</p>
                            </div>
                        </div>
                    </div>
                    <input type="hidden" id="url" data-url="/payment" data-del-url="/bankcard/delete.json"
                           data-index-url="/bankcard/index" data-choose-url="/bankcard/choose.json">
                    <!--内容区 end-->
                </div>
            </c:if>
            <c:if test="${bank=='false'}">
