...
<section class="layui-larry-box">
	<div class="larry-personal">
	    ...
	    <div class="layui-tab">
		         <!-- 操作日志 -->
                <form class="layui-form" action="lawadd" method="post">

					<div class="layui-form-item">
						<label class="layui-form-label">标题</label>
						<div class="layui-input-block">
							<input type="text" onBlur="checkText()" id="ntitle" name="title" required  lay-verify="required" placeholder="请输入产品名称" autocomplete="off" class="layui-input">
					...
					<div class="layui-form-item layui-form-text">
						...
						<div class="layui-input-block">
                            <div style="width:95%;align:margin 0 auto" id='editor'>
                                <p>${aboutusinfo.contents }</p>
                            </div>
                            <input type="hidden" id='contents' name='context'>
						</div>
					</div>
