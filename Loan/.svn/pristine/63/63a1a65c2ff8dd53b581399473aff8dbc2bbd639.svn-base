...
<div class="product-menu-contanier" id="productMenu">
    <ul class="product-menu clearfix">
        <li>
            <a href="/product/portal/index" id="menu_optimize" class=" active">投标工具 (<em id="optimizeCount"
                                                                                         data-count="14">14</em>)</a>
        </li>
        <li>
            <a href="/product/list?type=common" id="menu_common">散标 (<em id="commonCount">2</em>)</a>
        </li>
        <li>
...
<div class="container detail-container" id="contanier">
    <div class="shoulder" id="shoulderModel" onclick="click();">
        <div class="neck"><h2 class="title" id="headline">${all.headline}</h2><span
                class="sub-title">仅限累计出借少于3次的用户加入</span><a
            ...
            <div class="sub-left">
                <div class="sub-left-top">
                    <dl class="earnings">
                        <dt class="curRate"><b class="f-rate" id="interest">${all.interest}%</b><i>+</i><b
                                class="s-rate">5.00<span>%</span></b><b
                                class="text-tag" title="">新手奖励</b></dt>
                ...
                <ul class="subject-term g-cf" id="productTerm">
                    <c:forEach items="${list}" var="l">
                        <li id="${l.sid}" data-productid="${l.sid}" class>
            ...
            <script>
                $(document).ready(function () {
                    $("li").click(function () {
                        ...
                        $.post("/invest/jsbidding/", {sid: a}, function (data) {
                            var ms = data.ms;
            ...
            <div class="sub-right">
                ...
                <div class="during" id="during">
                    <form id="buyform" name="form"
                          action="/product/trade/new/buy?productTerm=1&amp;lockTermMode=2&amp;productType=11&amp;rp="
                        ...
                        <script>
                            ...
                            function tsts(v) {
                                ...
                                var ss = parseFloat(interest) + 5;      /*利息*/
                        ...
                        <div class="remind">小牛提醒您：市场有风险 出借需谨慎【<a href=" /portal/guide/security" target="_blank">查看保障</a>】
                        </div>
                    </form>
                </div>
                    <%--已售罄显示--%>
                ...
                <div class="novice abs" style="display: none">
                    <div class="info">本项目为新手专享项目</div>
                    <div class="describe">各类累计出借<span>少于3次</span>的客户才可加入</div>
                </div>
                <%--  登入后页面--%>
                <div class="during" id="duringss" style="display: none">
                    <form id="buyforms" name="form"
                          action="/product/trade/new/buy?productTerm=7&amp;lockTermMode=1&amp;productType=11&amp;rp="
                          method="post" autocomplete="off">
                        <div class="remaining-amount g-cf">
                            <label class="g-fl">网贷账户余额：</label>
                            <span class="g-fl">0.00</span><em class="g-fl">元</em>
                            <a class="to-recharge g-fr" href="/payment/recharge/index">充值</a>
                        </div>
                        <div class="target-earnings">
                            <div id="earningsWraps" class="g-dn">
                                <label>7天目标收益：</label><span id="realEarningss">0.00</span>元
                            </div>
                        </div>
                        <div class="purchase">
                            <input name="buyAmount" type="text" id="buyMoneys" placeholder="100元起投，100元递增"
                                   maxlength="20">
                        </div>
                        <div class="tips"></div>
                        <a class="to-buy" href="javascript:;">立即加入</a>
                        <input type="hidden" name="platform" value="1">
                        <input type="hidden" name="productId" value="65946678">
                        ...
                        <input type="hidden" id="ooh.token.name" name="ooh.token.name"
                               value="e0fd75b903f14d30957e3f4619e4e678">
                        <input type="hidden" id="ooh.token.value" name="ooh.token.value"
                               value="8H4N2P3LGX6XC7BGY2L2LX50UPL7NHAV">
    ...
    <div class="extend" id="extendModel">
        <ul class="tab">
            ...
            <li id="clic3" data-type="analyzeList" class="extend-trigger"><i
                    class="icon icon-analyze"></i><span>投标项目分析</span></li>
        ...
        <div class="items">
            ...
            <div class="item projectList tableList g-dn" id="projectListModel"
                ...
                <div class="content">
                    <div class="g-tl sequence"> 投标项目总金额<span>100000000+</span>元，共计<span>25000+</span>个项目 <a
                            class="extend-trigger color-blue" data-type="analyzeList" href="javascript:void(0)"
                            style="margin-left:15px">查看资产组合分析</a></div>
                    <table>
                        <tbody>
                        <tr>
                            <th>序号</th>
                        ...
                        <tr>
                            <td class="g-tc">1</td>
                            <td class="g-tc"><a target="_blank" href="/product/bid/detail/transfer/6454042988441334">安逸信Z20190421-1</a>
                            </td>
                            <td class="g-tc">1005天</td>
                            <td class="g-tc">588.93元</td>
                            <td class="g-tc">7.47%</td>
                            <td class="g-tc">招标中</td>
                        </tr>
                        <tr>
                            <td class="g-tc">2</td>
                            <td class="g-tc"><a target="_blank" href="/product/bid/detail/transfer/6454059888441277">安逸信Z20190421-144</a>
                            </td>
                            <td class="g-tc">152天</td>
                            <td class="g-tc">694.23元</td>
                            <td class="g-tc">10.5%</td>
                            <td class="g-tc">招标中</td>
                        </tr>
                        <tr>
                            <td class="g-tc">3</td>
                            <td class="g-tc"><a target="_blank" href="/product/bid/detail/transfer/6454055088441930">安逸信Z20190421-112</a>
                            </td>
                            <td class="g-tc">3218天</td>
                            <td class="g-tc">138.57元</td>
                            <td class="g-tc">10.68%</td>
                            <td class="g-tc">招标中</td>
                        </tr>
                        <tr>
                            <td class="g-tc">4</td>
                            <td class="g-tc"><a target="_blank" href="/product/bid/detail/transfer/6454062788441519">安逸信Z20190421-173</a>
                            </td>
                            <td class="g-tc">907天</td>
                            <td class="g-tc">1,197.82元</td>
                            <td class="g-tc">7.24%</td>
                            <td class="g-tc">招标中</td>
                        </tr>
                        <tr>
                            <td class="g-tc">5</td>
                            <td class="g-tc"><a target="_blank" href="/product/bid/detail/transfer/6454043388441321">安逸信Z20190421-5</a>
                            </td>
                            <td class="g-tc">901天</td>
                            <td class="g-tc">181.53元</td>
                            <td class="g-tc">7.23%</td>
                            <td class="g-tc">招标中</td>
                        </tr>
                        <tr>
                            <td class="g-tc">6</td>
                            <td class="g-tc"><a target="_blank" href="/product/bid/detail/transfer/6454049888441374">安逸信Z20190421-65</a>
                            </td>
                            <td class="g-tc">786天</td>
                            <td class="g-tc">1,087.47元</td>
                            <td class="g-tc">10.89%</td>
                            <td class="g-tc">招标中</td>
                        </tr>
                        <tr>
                            <td class="g-tc">7</td>
                            <td class="g-tc"><a target="_blank" href="/product/bid/detail/transfer/6454048388441374">安逸信Z20190421-50</a>
                            </td>
                            <td class="g-tc">778天</td>
                            <td class="g-tc">106.55元</td>
                            <td class="g-tc">10.86%</td>
                            <td class="g-tc">招标中</td>
                        </tr>
                        <tr>
                            <td class="g-tc">8</td>
                            <td class="g-tc"><a target="_blank" href="/product/bid/detail/transfer/6454050188441374">安逸信Z20190421-68</a>
                            </td>
                            <td class="g-tc">778天</td>
                            <td class="g-tc">1,088.60元</td>
                            <td class="g-tc">10.86%</td>
                            <td class="g-tc">招标中</td>
                        </tr>
                        <tr>
                            <td class="g-tc">9</td>
                            <td class="g-tc"><a target="_blank" href="/product/bid/detail/transfer/6454050088441374">安逸信Z20190421-67</a>
                            </td>
                            <td class="g-tc">778天</td>
                            <td class="g-tc">371.87元</td>
                            <td class="g-tc">10.86%</td>
                            <td class="g-tc">招标中</td>
                        </tr>
                        <tr>
                            <td class="g-tc">10</td>
                            <td class="g-tc"><a target="_blank" href="/product/bid/detail/transfer/6454055488441917">安逸信Z20190421-116</a>
                            </td>
                            <td class="g-tc">767天</td>
                            <td class="g-tc">171.17元</td>
                            <td class="g-tc">10.82%</td>
                            <td class="g-tc">招标中</td>
                        </tr>
                        </tbody>
                    </table>
                ...
                <div class="page paginator" style="visibility: visible;">
                    <div class="paginator-main" id="paginator-main" style="display: block;">
                        ...
                        <div class="paginator-list" style="width: 175px;">
                            <ol class="paginator-list-main" style="width: 87500px;">
                        ...
                        <div class="paginator-right">
                            <ol>
                                <li><a href="javascript:;" data-role="next">下一页</a></li>
