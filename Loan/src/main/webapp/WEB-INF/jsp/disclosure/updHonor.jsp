        ...
        <div style="position: relative;left:30px;width:1100px;text-align: center;height: ${li}px;">
            <c:forEach items="${l}" var="r">
                <div style="position: relative;left:10px;float:left;">
                    ...
                    <div style="line-height: 57px;">${r.title}<br><a href="/dis/del?id=${r.id}">删除</a></div>
                </div>
            </c:forEach>
            <div style="position: relative;left:20px;float:left;">
                <div style="width:273px;border:1px solid #e6e6e6;">
                    <a href="/dis/adds" title=""><img src="${pageContext.request.contextPath}/images/bf4e8a9d8056e9aef4a9b73f29bbe934.jpg" width="273" height="199" border="0" alt=""></a>
                </div>
        ...
        <div style="position: relative;left:30px;width:923px;text-align: center;height: ${ii}px;">
            <c:forEach items="${i}" var="r">
                <div style="position: relative;left:10px;float:left;">
                    ...
                    <div style="line-height: 57px;">${r.title}<br><a href="/dis/dels?id=${r.id}">删除</a></div>
                </div>
            </c:forEach>
            <div style="position: relative;left:20px;float:left;">
                <div style="width:273px;border:1px solid #e6e6e6;">
                    <a href="/dis/add" title=""><img src="${pageContext.request.contextPath}/images/bf4e8a9d8056e9aef4a9b73f29bbe934.jpg" width="273" height="199" border="0" alt=""></a>
                </div>
                <div style="line-height: 57px;">添加</div>
            </div>
        </div>
