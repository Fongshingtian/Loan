...
<section class="layui-larry-box">
	<div class="larry-personal">
		...
		<div class="layui-inline">
			<div class="layui-inline">
				<a class="layui-btn layui-btn-normal newsAdd_btn" href="/wlk/addLaw">添加法律法规</a>
			</div>
					...
					<tbody class="news_content">
						<c:forEach var="p" items="${list}">
							<tr style="height: 30px;">
								...
								<td width="10%">${p.cdate}</td>
								<td width="30%">${p.title}</td>

								<td><a href="/wlk/backonelaw?lid=${p.lid}"><button class="layui-btn layui-btn-normal">查看详情</button></a></td>
								...
								<td>
									...
									<a class="layui-btn layui-btn-danger layui-btn-mini" href="/wlk/delOneLaw?lid=${p.lid}"><i class="layui-icon"></i> 删除</a>
								</td>
							</tr>
